import{r as o,j as t,R as ie}from"./jsx-runtime-BfF-YriY.js";import{p as r,c as $,m as U,a as Z,b as C,d as V,n as ve}from"./config-C65m0oQ_.js";import{g as ue,h as F,j as fe,k as de,n as me,L as B,o as pe,M as xe,q as ge,O as ye,S as ke}from"./components-Bo-X3AJU.js";import{u as ee,f as be,a as _e,b as te}from"./use-reduced-motion-Dq7uKRRr.js";/**
 ...
 *
 * @license MIT
 */let D="positions";function je({getKey:e,...n}){let{isSpaMode:s}=ue(),l=F(),c=fe();de({getKey:e,storageKey:D});let h=o.useMemo(()=>{if(!e)return null;let i=e(l,c);return i!==l.key?i:null},[]);if(s)return null;let a=((i,d)=>{if(!window.history.state||!window.history.state.key){let f=Math.random().toString(32).slice(2);window.history.replaceState({key:f},"")}try{let v=JSON.parse(sessionStorage.getItem(i)||"{}")[d||window.history.state.key];typeof v=="number"&&window.scrollTo(0,v)}catch(f){console.error(f),sessionStorage.removeItem(i)}}).toString();return o.createElement("script",me({},n,{suppressHydrationWarning:!0,dangerouslySetInnerHTML:{__html:`(${a})(${JSON.stringify(D)}, ${JSON.stringify(h)})`}}))}const Se=({typeText:e,delay:n=0})=>{const[s,l]=o.useState(0);return o.useEffect(()=>{const c=setTimeout(()=>{const h=setInterval(()=>{l(a=>a<e.length?a+1:a)},50);return()=>clearInterval(h)},n);return()=>clearTimeout(c)},[e,n]),t.jsx("span",{children:e.slice(0,s)})},Ce=Se,ne=o.createContext(null),Le=o.createContext({});function we(){const e=o.useContext(ne);if(e===null)return[!0,null];const{isPresent:n,onExitComplete:s,register:l}=e,c=o.useId();return o.useEffect(()=>l(c),[]),!n&&s?[!1,()=>s&&s(c)]:[!0]}function se(){const e=o.useRef(!1);return ee(()=>(e.current=!0,()=>{e.current=!1}),[]),e}function $e(){const e=se(),[n,s]=o.useState(0),l=o.useCallback(()=>{e.current&&s(n+1)},[n]);return[o.useCallback(()=>be.postRender(l),[l]),n]}class Ie extends o.Component{getSnapshotBeforeUpdate(n){const s=this.props.childRef.current;if(s&&n.isPresent&&!this.props.isPresent){const l=this.props.sizeRef.current;l.height=s.offsetHeight||0,l.width=s.offsetWidth||0,l.top=s.offsetTop,l.left=s.offsetLeft}return null}componentDidUpdate(){}render(){return this.props.children}}function ze({children:e,isPresent:n}){const s=o.useId(),l=o.useRef(null),c=o.useRef({width:0,height:0,top:0,left:0});return o.useInsertionEffect(()=>{const{width:h,height:a,top:i,left:d}=c.current;if(n||!l.current||!h||!a)return;l.current.dataset.motionPopId=s;const f=document.createElement("style");return document.head.appendChild(f),f.sheet&&f.sheet.insertRule(`
