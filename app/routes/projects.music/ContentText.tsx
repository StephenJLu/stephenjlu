...
const ContentText = ({ visible, titleId }: { visible: boolean; titleId: string }) => (
  ...
  <List className={styles.description} data-visible={visible} size="l" as={'ul'}>
    <ListItem><Text className={styles.description} data-visible={visible} size={'l'}>For acoustic instrumentation, I have an Epiphone by Gibson Les Paul Model Cherry Sunburst electric guitar, and an Epiphone PR 350 acoustic guitar.</Text></ListItem>
