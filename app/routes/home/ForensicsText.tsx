...
<Text className={styles.description} data-visible={visible} size={'l'} as={'p'}>Since retiring from active casework, Stephen has shifted his focus towards leadership development in forensic science. Stephen's interest in leadership and public education is reflected in his recent book, <i>CSI to CEO</i>, where he covers forensic science topics such as DNA analysis, crime scene investigation, bloodstain pattern analysis, and forensic leadership for a general audience. In 2023, Stephen had the honor of graduating from the FBI San Diego's Citizens Academy as a demonstration of his continued dedication to public service.</Text>
  </>
