...
<Text className={styles.description} data-visible={visible} size={'l'} as={'p'}>In addition to his forensic science work, Stephen served as the Regional Director South for the California Association of Criminalists (CAC), where he organized regional study groups and hosted presentations by experts. As the Lead Webmaster for the CAC, he enhanced the organization’s public presence by overhauling its website for better communication and engagement. During the COVID-19 health crisis, Stephen guided the leadership through the transition to online training, sustaining the organization's ability to provide services to its members.</Text>
<Text className={styles.description} data-visible={visible} size={'l'} as={'p'}>Since retiring from active casework, Stephen has shifted his focus towards leadership development in forensic science. During graduate studies, he founded and operated the Forensic Leaders Training Center® as its Chief Executive Officer. His interest in leadership and public education is further reflected in his recent book, <Link secondary href={'https://www.csitoceo.com/'}><i>CSI to CEO</i></Link>, where he covers forensic science topics such as DNA analysis, crime scene investigation, bloodstain pattern analysis, and forensic leadership for a general audience. In 2023, Stephen had the honor of graduating from the FBI San Diego's Citizens Academy as a demonstration of his continued dedication to public service. In 2025—building on his programming and web development experience—he designed, developed, and shipped <Link secondary href={'https://www.striae.org/'}>Striae</Link>, a modern web app that streamlines comparison image annotation for forensic firearms examiners.</Text>
  </>
