...
const ResearchText = ({ visible, titleId }: { visible: boolean; titleId: string }) => (
  ...
  <TableRow className={styles.row} data-visible={visible}>
    ...
    <TableCell>
      ...
      <Text className={styles.description} data-visible={visible} size={'l'} as={'p'}>Stephen volunteers his time and resources to support and improve the lives of people living with <Link href={'/als'}>amyotrophic lateral sclerosis (ALS)</Link>. He served as Executive Director of A Lasting Strength, a non-profit organization dedicated to supporting patients living with ALS and mobility disabilities; he also served as a community member of UC San Diego Health's Patient and Family Advisory Council, working to unify patients, family, and team members to enhance the experience for everyone, evaluate strategies and improve quality and safety outcomes.</Text>
