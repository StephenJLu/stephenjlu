...
const ContentText = ({ visible, titleId }: { visible: boolean; titleId: string }) => (
  ...
  <List className={styles.description} data-visible={visible} size="l" as={'ul'}>
    ...
    <ListItem><Text className={styles.description} data-visible={visible} size={'l'}><Link secondary href={'https://www.perplexity.ai/comet'}>Comet</Link>/<Link secondary href={'https://www.google.com/chrome/'}>Chrome</Link> is my main browser, with <Link secondary  href={'https://www.mozilla.org/en-US/firefox/'}>Firefox</Link> as my secondary.</Text></ListItem>
