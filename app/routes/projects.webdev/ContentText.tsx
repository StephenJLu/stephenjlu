...
const ContentText = ({ visible, titleId }: { visible: boolean; titleId: string }) => (
  ...
  <List className={styles.description} data-visible={visible} size="l" as={'ul'}>
    ...
    <ListItem><Text className={styles.description} data-visible={visible} size={'l'}>I'm currently learning <Link secondary  href={'https://react.dev/'}>React</Link> for my frontend JavaScript library. I'd like to get into the mindset of the component-centric model for UI/UX design.</Text></ListItem>
