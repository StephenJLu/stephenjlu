...
import { default as ContentText2 } from './ContentText2';
...
export const Content2 = ({ id, visible, sectionRef }: ContentComponentProps) => {  
          ...
          {({ visible, nodeRef }: { visible: boolean; nodeRef: React.RefObject<HTMLDivElement> }) => (
            <>            
              <div className={styles.tag} aria-hidden>
                ...
                {(inViewport) => {
                  ...
                  return (
                    <div className={styles.tagText} data-visible={visible}>
                      {isInViewport && (
                        <DecoderText
                          text={'ALS Warriors and Advocates'}
                          delay={1600}
                        />
                      )}
                    </div>
                ...
                <ContentText2 visible={visible} titleId={titleId} />          
          </>
        )}        
      </Transition>
    </Section>
